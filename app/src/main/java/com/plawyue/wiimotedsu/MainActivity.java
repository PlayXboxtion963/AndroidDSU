...
public class MainActivity extends AppCompatActivity
    ...
    Button button_A, button_B, button_DUP, button_DDOWN, button_DLEFT, button_DRight, button_PLUS,
            button_DEDUCE, BUTTON_home, L2, R2, Touch, button_X, button_Y;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View layout = inflater.inflate(R.layout.senseseekbar, findViewById(R.id.elementseek));
        ...
        View layout2 = inflater2.inflate(R.layout.editlayout, findViewById(R.id.elementseek2));
        ...
        Button yourDialogButton2 = layout2.findViewById(R.id.okbtn);
        ...
        getWindow().setNavigationBarColor(
                ContextCompat.getColor(MainActivity.this, R.color.background));
    }
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (locked == false) {
            if (motionEvent.getAction() == MotionEvent.ACTION_DOWN) {
                ...
                switch (view.getId()) {
                    case R.id.button_A:
                        button_A.setBackground(getDrawable(R.drawable.pressed));
                        ms.A = 255;
                        break;
                    case R.id.button_B:
                        button_B.setBackground(getDrawable(R.drawable.pressed));
                        ms.B = 255;
                        break;
                    case R.id.Square:
                        button_X.setBackground(getDrawable(R.drawable.pressed));
                        ms.X = 255;
                        break;
                    case R.id.Tri:
                        button_Y.setBackground(getDrawable(R.drawable.pressed));
                        ms.Y = 255;
                        break;
                    case R.id.button_dUp:
                        button_DUP.setBackground(getDrawable(R.drawable.pressed));
                        ms.Dpad_UP = 255;
                        break;
                    case R.id.button_Ddown:
                        button_DDOWN.setBackground(getDrawable(R.drawable.pressed));
                        ms.Dpad_Down = 255;
                        break;
                    case R.id.button_Dleft:
                        button_DLEFT.setBackground(getDrawable(R.drawable.pressed));
                        ms.Dpad_Left = 255;
                        break;
                    case R.id.button_Dright:
                        button_DRight.setBackground(getDrawable(R.drawable.pressed));
                        ms.Dpad_Right = 255;
                        break;
                    case R.id.button_PLUS:
                        button_PLUS.setBackground(getDrawable(R.drawable.pressed));
                        ms.R1 = 255;
                        break;
                    case R.id.button_DEDUCE:
                        button_DEDUCE.setBackground(getDrawable(R.drawable.pressed));
                        ms.L1 = 255;
                        break;
                    case R.id.button_home:
                        BUTTON_home.setBackground(getDrawable(R.drawable.pressed));
                        ms.PS = 1;
                        break;
                    case R.id.button_L2:
                        L2.setBackground(getDrawable(R.drawable.pressed));
                        ms.L2 = 255;
                        break;
                    case R.id.button_R2:
                        R2.setBackground(getDrawable(R.drawable.pressed));
                        ms.R2 = 255;
                        break;
                    case R.id.buttonR3:
                        R3.setBackground(getDrawable(R.drawable.pressed));
                        ms.R3 = 1;
                        break;
                    case R.id.buttonL3:
                        L3.setBackground(getDrawable(R.drawable.pressed));
                        ms.L3 = 1;
                        break;
                    case R.id.buttonOption:
                        OPkey.setBackground(getDrawable(R.drawable.pressed));
                        ms.OPKEY = 1;
                        break;
                    case R.id.buttonShare:
                        SHARE.setBackground(getDrawable(R.drawable.pressed));
                        ms.SHARE = 1;
                        break;
                }
                ...
                switch (view.getId()) {
                    case R.id.button_A:
                        button_A.setBackground(getDrawable(R.drawable.unpress));
                        ms.A = 0;
                        break;
                    case R.id.button_B:
                        button_B.setBackground(getDrawable(R.drawable.unpress));
                        ms.B = 0;
                        break;
                    case R.id.Square:
                        button_X.setBackground(getDrawable(R.drawable.unpress));
                        ms.X = 0;
                        break;
                    case R.id.Tri:
                        button_Y.setBackground(getDrawable(R.drawable.unpress));
                        ms.Y = 0;
                        break;
                    case R.id.button_dUp:
                        button_DUP.setBackground(getDrawable(R.drawable.unpress));
                        ms.Dpad_UP = 0;
                        break;
                    case R.id.button_Ddown:
                        button_DDOWN.setBackground(getDrawable(R.drawable.unpress));
                        ms.Dpad_Down = 0;
                        break;
                    case R.id.button_Dleft:
                        button_DLEFT.setBackground(getDrawable(R.drawable.unpress));
                        ms.Dpad_Left = 0;
                        break;
                    case R.id.button_Dright:
                        button_DRight.setBackground(getDrawable(R.drawable.unpress));
                        ms.Dpad_Right = 0;
                        break;
                    case R.id.button_PLUS:
                        button_PLUS.setBackground(getDrawable(R.drawable.unpress));
                        ms.R1 = 0;
                        break;
                    case R.id.button_DEDUCE:
                        button_DEDUCE.setBackground(getDrawable(R.drawable.unpress));
                        ms.L1 = 0;
                        break;
                    case R.id.button_home:
                        BUTTON_home.setBackground(getDrawable(R.drawable.unpress));
                        ms.PS = 0;
                        break;
                    case R.id.button_L2:
                        L2.setBackground(getDrawable(R.drawable.unpress));
                        ms.L2 = 0;
                        break;
                    case R.id.button_R2:
                        R2.setBackground(getDrawable(R.drawable.unpress));
                        ms.R2 = 0;
                        break;
                    case R.id.buttonR3:
                        R3.setBackground(getDrawable(R.drawable.unpress));
                        ms.R3 = 0;
                        break;
                    case R.id.buttonL3:
                        L3.setBackground(getDrawable(R.drawable.unpress));
                        ms.L3 = 0;
                        break;
                    case R.id.buttonOption:
                        OPkey.setBackground(getDrawable(R.drawable.unpress));
                        ms.OPKEY = 0;
                        break;
                    case R.id.buttonShare:
                        SHARE.setBackground(getDrawable(R.drawable.unpress));
                        ms.SHARE = 0;
                        break;
                }
            }
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.Button_touchlock) {
            if (!locked) {
                ...
                Bitmap bitmap2 =
                        Bitmap.createBitmap(viewx.getWidth(), viewx.getHeight(), Bitmap.Config.ARGB_8888);
                Bitmap bitmap =
                        Bitmap.createBitmap(viewx.getWidth(), viewx.getHeight(), Bitmap.Config.ARGB_8888);
...
//                findViewById(R.id.sensitivelay).setVisibility(View.INVISIBLE);
        ...
        if (isEditMode && locked == false) {
            switch (view.getId()) {
                case R.id.button_A:
                    Inputbox(button_A, "ButtonA");
                    break;
                case R.id.button_B:
                    Inputbox(button_B, "ButtonB");
                    break;
                case R.id.Square:
                    Inputbox(button_X, "ButtonX");
                    break;
                case R.id.Tri:
                    Inputbox(button_Y, "ButtonY");
                    break;
                case R.id.button_dUp:
                    Inputbox(button_DUP, "ButtonDup");
                    break;
                case R.id.button_Ddown:
                    Inputbox(button_DDOWN, "ButtonDdown");
                    break;
                case R.id.button_Dleft:
                    Inputbox(button_DLEFT, "ButtonDleft");
                    break;
                case R.id.button_Dright:
                    Inputbox(button_DRight, "ButtonDright");
                    break;
                case R.id.button_PLUS:
                    Inputbox(button_PLUS, "Buttonplus");
                    break;
                case R.id.button_DEDUCE:
                    Inputbox(button_DEDUCE, "Buttondeduce");
                    break;
                case R.id.button_home:
                    Inputbox(BUTTON_home, "Buttonhome");
                    break;
                case R.id.button_L2:
                    Inputbox(L2, "ButtonL2");
                    break;
                case R.id.button_R2:
                    Inputbox(R2, "ButtonR2");
                    break;
                case R.id.buttonR3:
                    Inputbox(R3, "ButtonR3");
                    break;
                case R.id.buttonL3:
                    Inputbox(L3, "ButtonL3");
                    break;
                case R.id.buttonOption:
                    Inputbox(OPkey, "ButtonOP");
                    break;
                case R.id.buttonShare:
                    Inputbox(SHARE, "ButtonSh");
                    break;
            }
        }
    }
            ...
            switch (menuItem.getItemId()) {
                ...
                case R.id.about_menu:
                    Toast.makeText(MainActivity.this,
                                    "Thank For Using,Please report bugs in github.Playxboxtion963", Toast.LENGTH_LONG)
                            .show();
                    break;
            }
            return true;
    ...
    public void joystick_show() {
        ...
        myRockerView.setOnShakeListener(MyRockerView.DirectionMode.DIRECTION_8,
                new MyRockerView.OnShakeListener() {
                    @Override
                    public void onStart() {
                        //add code here
                    }
        ...
        myRockerView_2.setOnShakeListener(MyRockerView.DirectionMode.DIRECTION_8,
                new MyRockerView.OnShakeListener() {
                    @Override
                    public void onStart() {
                        //add code here
